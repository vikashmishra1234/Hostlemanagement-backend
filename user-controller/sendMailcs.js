import csAttendence from "../models/csAttendence.js";

import nodemailer from "nodemailer";

const sendEmailcs = async () => {
  try {
    let today = new Date();
    ...
    const csStudents = await csAttendence.find({ Status: "absent" });
