import ecAttendence from "../models/ecAttendence.js";

import nodemailer from "nodemailer";

const sendEmailec = async () => {
  try {
    let today = new Date();
    ...
    const csStudents = await ecAttendence.find({ Status: "absent" });
    ...
    csStudents.forEach(async (element) => {
      ...
      console.log("message sent ec", info.messageId);
    });
  } catch (error) {
